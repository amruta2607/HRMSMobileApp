                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: _capturedImage != null
                            ? AppColors.popOrange.withOpacity(0.4)
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: const Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Icon(Icons.camera_alt, color: AppColors.popOrange, size: 16),
                                  SizedBox(width: 4),
                                  Text(
                                    'Retake',
                                    style: TextStyle(
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(
                            ...
                            size: 36,
                            color: AppColors.popOrange.withOpacity(0.7),
                          ),
                        ),
