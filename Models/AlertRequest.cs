namespace MobileWebApi.Models
{
    ...
    public class ApproveRequestFromAlertRequest
    {
        ...
        /// <summary>
        /// Optional: If provided, will use this EventId instead of getting from alert
        /// </summary>
        public int? EventId { get; set; }
        
        /// <summary>
        /// Optional: If provided, will use this EventName instead of getting from alert
        /// </summary>
        public string? EventName { get; set; }
        
        /// <summary>
        /// Optional: Reason for approval (if needed)
        /// </summary>
